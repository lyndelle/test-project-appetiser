...
trait PersonSearch
{
	...
	public function scopeWherAge($query, $age)
	{	
		$start = now()->subYears($age + 1)->addDay()->toDateString();
		$end =  now()->subYears($age)->toDateString();
		
		return $query->whereBetween('birthday', [$start, $end]);
